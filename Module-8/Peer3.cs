...
namespace Module_8
{
    public class Peer3
    {
        ...
        public static void Main()
        {
            ...
            List<MySolution.Teacher> teachers = new List<MySolution.Teacher>();
        ...
        public class Course
        {
            ...
            private List<MySolution.Teacher> _teachers = new List<MySolution.Teacher>();
            ...
            public void AddTeacher(MySolution.Teacher teacher)
            {
                _teachers.Add(teacher);
            }

            public void AddTeachers(MySolution.Teacher[] teachers)
            {
